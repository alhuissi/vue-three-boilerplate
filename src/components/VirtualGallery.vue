...
export default {
  ...
  methods: {
    init() {
      ...
      // import images
      const texture = new Three.TextureLoader().load("/prof.jpg")
      const texture2 = new Three.TextureLoader().load("/2am.jpg")
      ...
      mesh.position.set(0, 4, -39)
      mesh2.position.set(23, 4, -39)
      this.scene.add(mesh)
